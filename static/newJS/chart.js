...
$(document).ready(function() {
  ...
  var do_endpoint = '/api/chart/doughnut-chart/'
  var do_data = []
  var do_labels = []
  ...
  $.ajax({
    ...
    success: function(dataDict){
      ...
      do_data = dataDict.data
      do_labels = dataDict.labels
      plotGraph()
    },
      ...
      var myDoughnutChart = new Chart(doughnut, {
          ...
          datasets: [
            {
              label: do_labels,
              data: do_data,
              backgroundColor: ['#4c84ff','#29cc97','#8061ef','#fec402','#53a322'],
              borderWidth: 1
        ...
        options: {
          ...
          tooltips: {
            callbacks: {
              title: function(tooltipItem, data) {
                return "Distributor : " + dataData["labels"][tooltipItem[0]["index"]];
              },
              label: function(tooltipItem, data) {
                return data["datasets"][0]["do_data"][tooltipItem["index"]];
              }
            },
            titleFontColor: "#888",
            bodyFontColor: "#555",
...
/*======== 23. BAR CHART3 ========*/
var endpoint = "/api/chart/bar-chart/"
var labels = []
var data = []
var color = []

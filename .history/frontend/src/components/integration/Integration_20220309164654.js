                        ...
                        <div className="">
                            {
                                generate === true ? (
                                    <div>
                                        <ViewApi data={apiData} firstTime={ apiData.length === 0 ? true : false } tokenGenerated={true}/>
                                    </div>
                                ) : <div>
                                        <ViewApi data={apiData} firstTime={ apiData.length === 0 ? true : false } tokenGenerated={false}/>
                                    </div>
                            }
                        </div>
                    </div>
